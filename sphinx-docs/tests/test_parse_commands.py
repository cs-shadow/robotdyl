...
def test_parse_focus():
    """ Tests screenshot._parse_focus() function.
    """
...
def test_parse_command():
    """ Tests screenshot._parse_command() function.
...
def test_parse_command_action_error():
    """ Tests ActionError(s) raised by screenshot._parse_focus() function.
    """
...
def test_parse_command_option_error():
    """ Tests OptionError(s) raised by screenshot._parse_focus() function.
    """
...
def test_parse_login():
    """ Tests screenshot._parse_login() function.
    """
...
def test_parse_nav_steps():
    """ Tests screenshot._parse_nav_steps() function.
    """
